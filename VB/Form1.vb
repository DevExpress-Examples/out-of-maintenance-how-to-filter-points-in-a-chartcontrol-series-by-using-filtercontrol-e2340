...
Namespace WindowsApplication1
	Partial Public Class Form1
		...
		Private Shared Function FilterData(ByVal series As Series, ByVal argument As Object, ByVal functionArguments() As String, ByVal values() As DataSourceValues) As SeriesPoint()
			Dim list As New List(Of SeriesPoint)()
			For i As Integer = 0 To values.Length - 1
				Dim ee As New ExpressionEvaluator(TypeDescriptor.GetProperties(values(0)("")), filterString, False)
				Dim obj As Object = ee.Evaluate(values(0)(""))
				If obj Is Nothing Then
					list.Add(New SeriesPoint(argument, (CType(values(0)(""), DataRowView))("ProductID")))
				End If
