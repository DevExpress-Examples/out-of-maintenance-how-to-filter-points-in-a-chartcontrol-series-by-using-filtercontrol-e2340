...
Namespace WindowsApplication1
    Partial Public Class Form1
        ...
        Private Shared Function FilterData(ByVal series As Series, ByVal argument As Object, ByVal functionArguments() As String, ByVal values() As DataSourceValues, ByVal colors() As Object) As SeriesPoint()
